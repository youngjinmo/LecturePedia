...
public class InitData {
    ...
    public void injection() {
        ...
        addLectures("스프링 웹 MVC", "김영한", 2L,"이 강좌는 자바 서블릿(Servlet) 기반의 MVC 프레임워크인 스프링 웹 MVC(이하 스프링 MVC)에 대해 " +
