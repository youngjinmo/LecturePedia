...
public class InitData {
    ...
    public void injection() {
        ...
        addLectures("스프링 프레임워크 입문",
                "백기선", 2L, "Spring-PetClinic이라는 스프링 공식 예제 프로젝트의 코드를 보며 다음의 스프링의 핵심 기능을 쉽고 빠르게 이해할 수 있습니다.", "https" +
                        "://www.inflearn.com/course/spring#", 17L);
